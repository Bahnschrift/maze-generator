...
export function aldousBroder(width, height) {
...
export function backtracker(width, height) {
    let grid = new Grid(width, height);
...
export function binaryTree(width, height) {
    let grid = new Grid(width, height);
...
export function growingTree(width, height, freqNewest, freqOldest, freqRandom) {
    let grid = new Grid(width, height);
    let stack = [grid.grid[randInt(0, height)][randInt(0, width)]];
    stack[0].visited = true;
...
export function huntAndKill(width, height) {
    let grid = new Grid(width, height);
    let cell = grid.grid[randInt(0, height)][randInt(0, width)];
    cell.visited = true;
    while (true) {
...
export function prims(width, height) {
    let grid = new Grid(width, height);
    let walls = [];
    let cell = grid.grid[randInt(0, height)][randInt(0, width)];
    cell.visited = true;
...
export function recursiveDivision(width, height) {
...
export function sidewinder(width, height) {
    let grid = new Grid(width, height);
